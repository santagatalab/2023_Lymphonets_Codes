...
mkdir([filename.folders.main filename.folders.output filename.folders.segmimages])
...
%             FileTif = [filename.folders.main filename.folders.output  fold filesep filename.folders.fullstacks core  filename.suffix];
            FileTif = [filename.folders.main filename.folders.output  filename.folders.fullstacks core  filename.suffix];
            segfile = [filename.folders.main filename.folders.output filename.folders.segmimages core '_Seg.tif'];
            IlastikTif = [filename.folders.main filename.folders.output filename.folders.ilastikseg filename.folders.ilastikprob core  filename.ilastiksuffix];
            
            if exist(segfile,'file')==2
                disp(['Image ' core ' alredy segmented'])
                continue
            elseif exist(IlastikTif,'file')~=2
                disp(['Prob image ' core ' not found'])
                continue
            else
            ...
            try 
                ...
                DAPI_last = imread(FileTif,'Index',filename.cycles*4-3);
            catch
...
%             end
           ...
           check_file = [filename.folders.main filename.folders.output filename.folders.segmimages core  '_checkseg.tif'];
